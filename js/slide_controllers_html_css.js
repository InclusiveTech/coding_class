...
app.controller('SlideController', function($scope, $sce, localStorageService) {
    $scope.slideImages = [
        ...
        'slides/html-css-curriculum/100.png',
        'slides/html-css-curriculum/101.png',
        'slides/html-css-curriculum/102.png',
        'slides/html-css-curriculum/103.png',
        'slides/html-css-curriculum/104.png',
        'slides/html-css-curriculum/105.png',
        'slides/html-css-curriculum/106.png',
        'slides/html-css-curriculum/107.png',
        'slides/html-css-curriculum/108.png',
        'slides/html-css-curriculum/109.png',
        'slides/html-css-curriculum/110.png',
        'slides/html-css-curriculum/111.png',
        'slides/html-css-curriculum/112.png',
        'slides/html-css-curriculum/113.png',
        'slides/html-css-curriculum/114.png',
        'slides/html-css-curriculum/115.png',
        'slides/html-css-curriculum/116.png',
        'slides/html-css-curriculum/117.png',
        ];
